...
const ListarTarefa = () => {
  ...
  const handleOpenConfirmacao = (tarefa) => {
  ...
  const confirmarExclusao = () => {
    if (tarefaParaDeletar) {
      handleDeletar(tarefaParaDeletar.idTarefa);
                  ...
                  >
                    ...
                    <TableCell align="center">
                      <Button
                        variant="contained"
                        color="error"
                        onClick={() => handleOpenConfirmacao(row)}
                      >
              ...
              <CardContent>
                ...
                {tarefaParaDeletar && (
                  <Typography variant="body2" color="textSecondary">
                    ...
                    {tarefaParaDeletar.tituloTarefa}"?
                  </Typography>
                )}
              </CardContent>
              <CardActions>
                <Button onClick={handleCloseConfirmacao} color="primary">
                  Cancelar
                </Button>
